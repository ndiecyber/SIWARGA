      ...
      <div className="container mx-auto max-w-275 px-6">
        <div className="mb-12 text-center max-w-3xl mx-auto">
          ...
          <p
            ...
            title="Dirancang khusus untuk memudahkan pengurus dan warga RT dalam mengelola administrasi sehari-hari."
          >
            Dirancang khusus untuk memudahkan pengurus dan warga RT dalam mengelola administrasi sehari-hari.
          </p>
        </div>
        ...
        >
          {features.map((f, i) => {
            ...
            return (
              <div
                key={f.title}
                className={`group relative overflow-hidden rounded-2xl border border-border bg-card p-6 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_12px_32px_hsl(var(--primary)/.1)] ${visible
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3.5 mb-4 w-full">
                  <div className="flex items-center gap-3.5">
                    <div
                      className={`flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-[13px] ${f.iconBg} ${f.iconColor}`}
                    >
                      <Icon className="h-[22px] w-[22px]" />
                    </div>
                    <h3 className="font-fraunces text-[17px] font-semibold text-foreground leading-tight">
                      {f.title}
                    </h3>
                  </div>
                  <span
                    className={`rounded-full px-2.5 py-0.5 text-[11px] font-semibold flex-shrink-0 ${f.tagBg} ${f.tagColor}`}
                  >
                    {f.tag}
                  </span>
                </div>
